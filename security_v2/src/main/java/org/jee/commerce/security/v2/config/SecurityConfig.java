package org.jee.commerce.security.v2.config;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private final UserAuthenticationService uds;

    public SecurityConfig(JWTFilter filter, UserAuthenticationService uds) {
        this.filter = filter;
        this.uds = uds;
    }
